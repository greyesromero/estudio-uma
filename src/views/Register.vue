		...
		<v-content style="background:#ffffff !important">
							...
							<v-card :loading="loading" class="mx-auto" min-width="345" tile flat>
								<v-card-text class="pb-0">
									...
									<v-form v-model="valid" :lazy-validation="lazy"  ref="form">
										...
										<v-text-field v-model.lazy="email" outlined color="secondary" label="E-mail"  :rules="emailRules" required></v-text-field>
									</v-form>
								...
								<v-card-actions class="align-self-center align-content-center justify-center center align-center">
									...
									<v-btn @click="register" tile color="secondary" class="font-weight-bold text-none pl-5 pr-5" >Registrarse</v-btn>
								</v-card-actions>
							</v-card>
						</v-col>
					</v-row>
			...
			<v-dialog v-model="dialog" persistent max-width="290" timeout = "2000">
				<v-card>
						...
						<v-card-text>¡Su registro ha sido completado!</v-card-text>
						<v-card-actions>
						<v-spacer></v-spacer>
